Real Estate listing website built with React and FireStore database. You can search and login to list a property. Inspiration taken from Brad Traversey's React course on Udemy.
